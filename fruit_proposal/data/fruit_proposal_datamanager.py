...
@dataclass
class FruitDataManagerConfig(DataManagerConfig):
...
class FruitDataManager(DataManager, Generic[TDataset]):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.train_dataparser_outputs: FruitProposalDataParserOutputs = self.dataparser.get_dataparser_outputs(split="train")
