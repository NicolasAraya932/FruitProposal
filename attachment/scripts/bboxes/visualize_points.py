...
class VisualizePoints:
    ...
    def getViserServer(self):
        return self.ViserServer

    def wait_for_user_input(self, wait=True):
        while(wait):
